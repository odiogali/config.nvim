...
local function get_current_function_name()
  ...
  -- Get the text for the function name, which is typically the first child
  local function_name_node = expr:child(1) -- The first child should be the function name
